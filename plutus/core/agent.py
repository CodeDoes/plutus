...
class AgentRuntime:
    ...
    def _build_system_prompt(self) -> str:
        ...
        parts.append(
            "\n## Self-Extension & Continuous Self-Improvement\n"
            "You can — and MUST — extend your own capabilities over time.\n\n"
            ...
            "new API connectors for any REST service.\n\n"
            "**Self-Improvement Directive (MANDATORY):**\n"
            "After completing ANY non-trivial task, you MUST ask yourself:\n"
            "  1. Did I do anything repetitive that a reusable skill or tool could automate?\n"
            "  2. Did I interact with a web service or API that deserves a custom connector?\n"
            "  3. Did I write a script or snippet I will likely need again?\n"
            "If the answer to ANY of these is yes, BUILD THE SKILL/TOOL/CONNECTOR immediately.\n\n"
            "**Skills Index:** Maintain a skills index at ~/.plutus/skills/INDEX.md. "
            "Update it every time you create or improve a skill. "
            "Before starting any new task, check the index for relevant existing skills.\n\n"
            "**Worker Delegation:** For long-running or parallelisable plan steps, "
            "spawn a background worker instead of blocking:\n"
            ...
            "This lets you run multiple tasks in parallel without blocking.\n\n"
            "**Heartbeat Self-Improvement:** When woken by a heartbeat with no active plan, "
            "proactively review recent tasks and build at least one new skill or tool that "
            "would make future tasks faster. Never idle — always improve.\n\n"
